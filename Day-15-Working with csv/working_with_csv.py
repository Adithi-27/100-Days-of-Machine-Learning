...
Original file is located at
    https://colab.research.google.com/drive/1uDzmy9BWRDr-OPicNaiHxd44H4Ib9-No
...
pd.read_csv('/content/aug_train.csv',usecols=['gender'])
series = df.squeeze("columns")
print (series)

"""9. Skiprows/nrows Parameter"""

pd.read_csv('/content/aug_train.csv',nrows=100)
...
pd.read_csv('/content/IPL Matches 2008-2020.csv',converters={'team1':rename})

"""14. na_values parameter"""

pd.read_csv('/content/aug_train.csv',na_values=['Male',])
